...
function stop(){if(source){try{source.stop()}catch{}try{source.disconnect()}catch{}}if(gain){try{gain.disconnect()}catch{}}source=null;gain=null;playing=false;cancelAnimationFrame(animationId);progress.style.width="0%";previewTime.textContent="0:00 / 0:20";playBtn.textContent="▶"}
